...
public class Main{
	...
	public static void main(String[] args)throws Exception{
		...
		//String str = "W W G W W W W W W G R R R R R R R R Y Y R Y Y Y Y Y Y W O O O O O O O O Y G G G G G G G O B B B B B B B B B";		RubiksCube3X3 cube = new RubiksCube3X3(str);
...
Y G W R R R B G O R B B B B B R B O R O W G O O R W G O W G Y G Y G R Y B Y W Y Y G O R G W O Y W W W Y O B
*/
