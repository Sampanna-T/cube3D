...
public class Node {
    ...
    /**
     * returns true if i,j,k represents a valid corner Node for given dimension i.e.
     * color[] holding 3 colors
     * 
     * @param i
     *                  represents index i out of (i,j,k) in 3D cube
     * @param j
    ...
    /**
     * returns true if i,j,k represents a valid edge Node for given dimension i.e.
     * color[] holding 2 colors
     * 
     * @param i
     *                  represents index i out of (i,j,k) in 3D cube
     * @param j
    ...
    /**
     * returns true if i,j,k represents a valid center Node for given dimension i.e.
     * color[] holding 1 color
     * 
     * @param i
     *                  represents index i out of (i,j,k) in 3D cube
     * @param j
