...
public interface Solve3X3{
	...
	*/
	...
	/**
	* Solves the 3X3 RubiksCube and adds [move to be performed, RubiksCube state] pair to solution list
    * @param cube3X3
    * Reference to RubiksCube3X3 object
    * @return List
	*/
    public static List<Pair<String,String>> solveCube(RubiksCube3X3 cube3X3){
        try{
            ...
            add("PLUS BOTTOM COMPLETE************************",cube3X3,solution);
            layerFirst(cube3X3,solution);
            add("LAYER FIRST COMPLETE************************",cube3X3,solution);
            layerSecond(cube3X3,solution);
            add("LAYER SECOND COMPLETE************************",cube3X3,solution);
            plusTop(cube3X3,solution);
            add("PLUS TOP COMPLETE************************",cube3X3,solution);
            alignCenter(cube3X3,solution);
            add("ALIGN CENTER COMPLETE************************",cube3X3,solution);
            corner(cube3X3,solution);
            add("CORNER COMPLETE************************",cube3X3,solution);
            layerThird(cube3X3,solution);
            add("LAYER THIRD COMPLETE************************",cube3X3,solution);
            return solution;
        }
        catch(Exception e){
            e.printStackTrace();
	...
	/**
	* solves PlusBottom of RubiksCube i.e. Stage1 and adds [move to be performed, RubiksCube state]
	...
	*/
    private static void plusBottom(RubiksCube3X3 cube3X3,List <Pair<String,String>>solution)throws Exception{
        ...
        if(optimizerObj.optimize((byte)1))return;
	...
	/**
	* solves LayerFirst of RubiksCube i.e. Stage2 and adds [move to be performed, RubiksCube state]
    * pair to the solution list
    * @param cube3X3
    * Reference to RubiksCube3X3 object
    * @param solution
	...
	*/
    private static void layerFirst(RubiksCube3X3 cube3X3,List <Pair<String,String>>solution)throws Exception{
        Optimizer optimizerObj = new Optimizer(cube3X3,solution);
        if(optimizerObj.optimize((byte)2))return;
	...
	/**
	* solves LayerSecond of RubiksCube i.e. Stage3 and adds [move to be performed, RubiksCube state]
    * pair to the solution list
    * @param cube3X3
    * Reference to RubiksCube3X3 object
    * @param solution
	...
	*/
    private static void layerSecond(RubiksCube3X3 cube3X3,List <Pair<String,String>>solution)throws Exception{
        Optimizer optimizerObj = new Optimizer(cube3X3,solution);
        if(optimizerObj.optimize((byte)3))return;        
	...
	/**
	* solves PlusTop of RubiksCube i.e. Stage4 and adds [move to be performed, RubiksCube state]
    * pair to the solution list
    * @param cube3X3
    * Reference to RubiksCube3X3 object
    * @param solution
	...
	*/
    private static void plusTop(RubiksCube3X3 cube3X3,List <Pair<String,String>>solution)throws Exception{
        Optimizer optimizerObj = new Optimizer(cube3X3,solution);
        if(optimizerObj.optimize((byte)4))return;       
	...
	/**
	* solves AlignCenter of RubiksCube i.e. Stage5 and adds [move to be performed, RubiksCube state]
    * pair to the solution list
    * @param cube3X3
    * Reference to RubiksCube3X3 object
    * @param solution
	...
	*/
    private static void alignCenter(RubiksCube3X3 cube3X3,List <Pair<String,String>>solution)throws Exception{
        Optimizer optimizerObj = new Optimizer(cube3X3,solution);
        if(optimizerObj.optimize((byte)5))return;
	...
	/**
	* solves Corner of RubiksCube i.e. Stage6 and adds [move to be performed, RubiksCube state]
    * pair to the solution list
    * @param cube3X3
    * Reference to RubiksCube3X3 object
    * @param solution
	...
	*/
    private static void corner(RubiksCube3X3 cube3X3,List <Pair<String,String>>solution)throws Exception{
        Optimizer optimizerObj = new Optimizer(cube3X3,solution);
        if(optimizerObj.optimize((byte)6))return; 
	...
	/**
	* solves LayerThird of RubiksCube i.e. Stage7 and adds [move to be performed, RubiksCube state]
    * pair to the solution list
    * @param cube3X3
    * Reference to RubiksCube3X3 object
    * @param solution
	...
	*/
    private static void layerThird(RubiksCube3X3 cube3X3,List <Pair<String,String>>solution)throws Exception{
        Optimizer optimizerObj = new Optimizer(cube3X3,solution);
        if(optimizerObj.optimize((byte)7))return; 
